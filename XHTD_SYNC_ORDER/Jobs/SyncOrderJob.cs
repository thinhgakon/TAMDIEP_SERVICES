...
using RestSharp;
using XHTD_SYNC_ORDER.Models.Response;
using XHTD_SERVICES.Data.Models.Response;
using XHTD_SYNC_ORDER.Models.Request;
using Newtonsoft.Json;
using System.Configuration;
using System.Collections.Specialized;
using XHTD_SYNC_ORDER.Models.Values;

namespace XHTD_SYNC_ORDER.Jobs
{
    public class SyncOrderJob : IJob
    {
        ...
        public List<OrderItemResponse> GetWebsaleOrder()
        {
            ...
            return responseData.collection.OrderBy(x => x.id).Take(3).ToList();
        }
