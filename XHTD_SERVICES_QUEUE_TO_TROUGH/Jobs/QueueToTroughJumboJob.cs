...
namespace XHTD_SERVICES_QUEUE_TO_TROUGH.Jobs
{
    public class QueueToTroughJumboJob : IJob
    {
        ...
        protected const string SERVICE_ACTIVE_CODE = "AUTO_QUEUE_TO_TROUGH_JUMBO_ACTIVE";
        ...
        public async Task Execute(IJobExecutionContext context)
        {
            ...
            await Task.Run(async () =>
            {
                ...
                if (!isActiveService)
                {
                    _logger.Info("Service tự động xếp xe vào máng JUMBO đang TẮT");
                    return;
                }
        ...
        {
            _logger.Info("Start process QueueToCall JUMBO service");
