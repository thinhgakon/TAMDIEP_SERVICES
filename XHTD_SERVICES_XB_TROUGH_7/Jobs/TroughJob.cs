...
using XHTD_SERVICES_XB_TROUGH_7.Models.Response;
...
using XHTD_SERVICES_XB_TROUGH_7.Devices;
using XHTD_SERVICES.Helper.Models.Request;
using XHTD_SERVICES_XB_TROUGH_7.Business;

namespace XHTD_SERVICES_XB_TROUGH_7.Jobs
{
    public class TroughJob : IJob
    {
        ...
        private readonly string TROUGH_CODE = "7";
                    ...
                    if (openResult != 0)
                    {
                        ...
                        if (Program.CountToSendFailOpenPort == 3)
                        {
                            ...
                            if (Program.SendFailOpenPortLastTime == null || Program.SendFailOpenPortLastTime < DateTime.Now.AddMinutes(-3))
                            {
                                ...
                                var pushMessage = $"Xi bao 7: mở kết nối không thành công đến anten {PegasusAdr}. Vui lòng báo kỹ thuật kiểm tra";
