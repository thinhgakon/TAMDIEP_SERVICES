...
namespace XHTD_SERVICES_LED.Jobs
{
    ...
    public class Led12RealtimeJob : IJob, IDisposable
    {
        ...
        public Led12RealtimeJob(LedLogger logger, MachineRepository machineRepository, TroughRepository troughRepository, StoreOrderOperatingRepository storeOrderOperatingRepository)
        {
            _logger = logger;
