...
namespace XHTD_SERVICES_LED.Jobs
{
    ...
    public class Led2XiBaoJob : IJob, IDisposable
    {
        ...
        protected readonly int PLC_PORT_NUMBER = 13000;
        private const int BUFFER_SIZE = 1024;

        protected readonly string MACHINE_CODE = MachineCode.MACHINE_XI_BAO_2;

        public Led2XiBaoJob(LedLogger logger, MachineRepository machineRepository, TroughRepository troughRepository, StoreOrderOperatingRepository storeOrderOperatingRepository)
        {
            _logger = logger;
