...
using XHTD_SERVICES_XB_TROUGH_8.Models.Response;
...
using Autofac;
using XHTD_SERVICES_XB_TROUGH_8.Hubs;
using System.Net.NetworkInformation;
using XHTD_SERVICES_XB_TROUGH_8.Devices;
using XHTD_SERVICES.Helper.Models.Request;
using XHTD_SERVICES_XB_TROUGH_8.Business;
                    ...
                    if (openResult != 0)
                    {
                        ...
                        if (Program.CountToSendFailOpenPort == 3)
                        {
                            ...
                            if (Program.SendFailOpenPortLastTime == null || Program.SendFailOpenPortLastTime < DateTime.Now.AddMinutes(-3))
                            {
                                ...
                                var pushMessage = $"Xi bao 8: mở kết nối không thành công đến anten {PegasusAdr}. Vui lòng báo kỹ thuật kiểm tra";
