...
using XHTD_SERVICES_CANVAO_2.Business;
...
namespace XHTD_SERVICES_CANVAO_2.Jobs
{
    ...
    public class Tram951ModuleJob : IJob
    {
        ...
        protected readonly string SERVICE_DIRECTION_CANVAO_2 = "DIRECTION_CANVAO_2";
        ...
        public async Task LoadSystemParameters()
        {
            ...
            var directionParameter = parameters.FirstOrDefault(x => x.Code == SERVICE_DIRECTION_CANVAO_2);
                    ...
                    if (openResult != 0)
                    {
                        ...
                        if (Program.CountToSendFailOpenPort == 3)
                        {
                            ...
                            if (Program.SendFailOpenPortLastTime == null || Program.SendFailOpenPortLastTime < DateTime.Now.AddMinutes(-3))
                            {
                                ...
                                var pushMessage = $"Cân vào 2: mở kết nối không thành công đến anten {PegasusAdr}. Vui lòng báo kỹ thuật kiểm tra";
