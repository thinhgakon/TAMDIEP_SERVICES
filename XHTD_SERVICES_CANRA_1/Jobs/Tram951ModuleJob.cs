...
namespace XHTD_SERVICES_CANRA_1.Jobs
{
    ...
    public class Tram951ModuleJob : IJob
    {
        ...
        protected readonly string SERVICE_DIRECTION_CANRA_1 = "DIRECTION_CANRA_1";
        ...
        public async Task LoadSystemParameters()
        {
            ...
            var directionParameter = parameters.FirstOrDefault(x => x.Code == SERVICE_DIRECTION_CANRA_1);
                    ...
                    if (openResult != 0)
                    {
                        ...
                        if (Program.CountToSendFailOpenPort == 3)
                        {
                            ...
                            if (Program.SendFailOpenPortLastTime == null || Program.SendFailOpenPortLastTime < DateTime.Now.AddMinutes(-3))
                            {
                                ...
                                var pushMessage = $"Cân ra 1: mở kết nối không thành công đến anten {PegasusAdr}. Vui lòng báo kỹ thuật kiểm tra";
