...
using XHTD_SERVICES_CANRA_2.Hubs;
...
namespace XHTD_SERVICES_CANRA_2.Jobs
{
    ...
    public class Tram951ModuleJob : IJob
    {
        ...
        protected readonly string SCALE_CURRENT_VEHICLE = "SCALE_2_CURRENT_VEHICLE";
        ...
        protected readonly string SERVICE_DIRECTION_CANRA_2 = "DIRECTION_CANRA_2";
        ...
        public async Task LoadSystemParameters()
        {
            ...
            var directionParameter = parameters.FirstOrDefault(x => x.Code == SERVICE_DIRECTION_CANRA_2);
                    ...
                    if (openResult != 0)
                    {
                        ...
                        if (Program.CountToSendFailOpenPort == 3)
                        {
                            ...
                            if (Program.SendFailOpenPortLastTime == null || Program.SendFailOpenPortLastTime < DateTime.Now.AddMinutes(-3))
                            {
                                ...
                                var pushMessage = $"Cân ra 2: mở kết nối không thành công đến anten {PegasusAdr}. Vui lòng báo kỹ thuật kiểm tra";
