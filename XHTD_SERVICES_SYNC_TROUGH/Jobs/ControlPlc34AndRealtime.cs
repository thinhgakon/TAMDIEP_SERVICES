...
namespace XHTD_SERVICES_SYNC_TROUGH.Jobs
{
    ...
    public class ControlPlc34AndRealtime : IJob, IDisposable
    {
        ...
        public ControlPlc34AndRealtime(
        ...
        private async Task MachineJobProcess(List<tblMachine> machines)
        {
            ...
            foreach (var machine in machines)
            {
                ...
                {
                    _logger.LogInfo($"MachineJobProcess 34 ERROR: Code={machine.Code} --- {ex.Message} --- {ex.StackTrace}");
                }
            }
        }
