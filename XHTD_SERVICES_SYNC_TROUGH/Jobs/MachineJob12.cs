...
namespace XHTD_SERVICES_SYNC_TROUGH.Jobs
{
    ...
    public class MachineJob12 : IJob, IDisposable
    {
        ...
        public MachineJob12(MachineRepository machineRepository, Notification notification, SyncTroughLogger logger)
        {
        ...
        public void SendNotificationAPI(string machineType, string machineCode, string startStatus, string stopStatus)
        {
            ...
            {
                _logger.LogInfo($"SendNotificationAPI Machine 1|2 Ex: {ex.Message} == {ex.StackTrace} == {ex.InnerException}");
            }
        }
