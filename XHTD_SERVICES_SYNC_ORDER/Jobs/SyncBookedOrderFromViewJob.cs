    ...
    public class SyncBookedOrderFromViewJob : IJob
    {
        ...
        public List<OrderItemResponse> GetWebsaleViewOrder()
        {
            ...
            OrderItemResponse mapFunc(IDataReader reader) => new OrderItemResponse
            {
                ...
                orderDate = reader["ORDER_DATE"] == DBNull.Value ? null : reader.GetDateTime(8).ToString("yyyy-MM-ddTHH:mm:ss"),
                ...
                lastUpdatedDate = reader["LAST_UPDATE_DATE"] == DBNull.Value ? null : reader.GetDateTime(13).ToString("yyyy-MM-ddTHH:mm:ss")
            };
