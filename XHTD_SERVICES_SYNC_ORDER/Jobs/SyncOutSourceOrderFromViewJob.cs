        ...
        public async Task<bool> SyncWebsaleOrderToHoangThach(OrderItemResponse websaleOrder)
        {
            ...
            else if (stateId == (int)OrderState.DA_XUAT_HANG)
            {
                ...
                var obj = new HTOrderRequest
                {
                    ...
                    DELIVERY_CODE_HT = websaleOrder.deliveryCodeTgc,
                    VEHICLE_CODE = websaleOrder.vehicleCode,
                    TIME_IN = !string.IsNullOrEmpty(websaleOrder.timeIn) ? timeInDate.ToString("dd/MM/yyyy HH:mm:ss") : DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"),
                    TIME_OUT = !string.IsNullOrEmpty(websaleOrder.timeOut) ? timeOutDate.ToString("dd/MM/yyyy HH:mm:ss") : DateTime.Now.ToString("dd/MM/yyyy HH:mm:ss"),
