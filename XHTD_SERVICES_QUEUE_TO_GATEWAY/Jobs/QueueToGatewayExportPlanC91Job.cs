...
{
    public class QueueToGatewayExportPlanC91Job : IJob
    {
        ...
        public QueueToGatewayExportPlanC91Job(StoreOrderOperatingRepository storeOrderOperatingRepository)
        {
            ...
            try
            {
                ...
                using (var db = new XHTD_Entities())
                {
                    ...
                    foreach (var itemConfig in callConfigs)
                    {
                        ...
                        int maxVehicleConfig = (int)itemConfig.MaxVehicleC91;
