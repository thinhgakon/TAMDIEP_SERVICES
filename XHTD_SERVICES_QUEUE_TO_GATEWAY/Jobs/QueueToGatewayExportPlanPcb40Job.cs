...
{
    public class QueueToGatewayExportPlanPcb40Job : IJob
    {
        ...
        public QueueToGatewayExportPlanPcb40Job(StoreOrderOperatingRepository storeOrderOperatingRepository)
        {
            ...
            try
            {
                ...
                using (var db = new XHTD_Entities())
                {
                    ...
                    foreach (var itemConfig in callConfigs)
                    {
                        ...
                        int maxVehicleConfig = (int)itemConfig.MaxVehiclePcb40;
