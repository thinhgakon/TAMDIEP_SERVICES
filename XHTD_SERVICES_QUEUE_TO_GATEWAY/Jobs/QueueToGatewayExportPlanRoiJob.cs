...
{
    public class QueueToGatewayExportPlanRoiJob : IJob
    {
        ...
        public QueueToGatewayExportPlanRoiJob(StoreOrderOperatingRepository storeOrderOperatingRepository)
        {
            ...
            try
            {
                ...
                using (var db = new XHTD_Entities())
                {
                    ...
                    foreach (var itemConfig in callConfigs)
                    {
                        ...
                        int maxVehicleConfig = (int)itemConfig.MaxVehicleRoi;
