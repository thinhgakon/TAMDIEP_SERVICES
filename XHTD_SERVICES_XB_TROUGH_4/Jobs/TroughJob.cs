...
using XHTD_SERVICES_XB_TROUGH_4.Models.Response;
...
using XHTD_SERVICES_XB_TROUGH_4.Devices;
using XHTD_SERVICES.Helper.Models.Request;
using XHTD_SERVICES_XB_TROUGH_4.Business;

namespace XHTD_SERVICES_XB_TROUGH_4.Jobs
{
    public class TroughJob : IJob
    {
        ...
        private string PegasusAdr = "192.168.13.198";

        private readonly string TROUGH_CODE = "4";
                    ...
                    if (openResult != 0)
                    {
                        ...
                        if (Program.CountToSendFailOpenPort == 3)
                        {
                            ...
                            if (Program.SendFailOpenPortLastTime == null || Program.SendFailOpenPortLastTime < DateTime.Now.AddMinutes(-3))
                            {
                                ...
                                var pushMessage = $"Xi bao 4: mở kết nối không thành công đến anten {PegasusAdr}. Vui lòng báo kỹ thuật kiểm tra";
