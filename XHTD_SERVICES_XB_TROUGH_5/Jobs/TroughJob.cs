...
using Autofac;
using XHTD_SERVICES_XB_TROUGH_5.Hubs;
using System.Net.NetworkInformation;
using XHTD_SERVICES_XB_TROUGH_5.Devices;
using XHTD_SERVICES.Helper.Models.Request;
using XHTD_SERVICES_XB_TROUGH_5.Business;

namespace XHTD_SERVICES_XB_TROUGH_5.Jobs
{
    public class TroughJob : IJob
    {
        ...
        private string PegasusAdr = "192.168.13.212";

        private readonly string TROUGH_CODE = "5";
                    ...
                    if (openResult != 0)
                    {
                        ...
                        if (Program.CountToSendFailOpenPort == 3)
                        {
                            ...
                            if (Program.SendFailOpenPortLastTime == null || Program.SendFailOpenPortLastTime < DateTime.Now.AddMinutes(-3))
                            {
                                ...
                                var pushMessage = $"Xi bao 5: mở kết nối không thành công đến anten {PegasusAdr}. Vui lòng báo kỹ thuật kiểm tra";
