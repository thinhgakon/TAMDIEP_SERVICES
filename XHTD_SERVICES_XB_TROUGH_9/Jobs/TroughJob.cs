...
using XHTD_SERVICES_XB_TROUGH_9.Models.Response;
...
using Autofac;
using XHTD_SERVICES_XB_TROUGH_9.Hubs;
using System.Net.NetworkInformation;
using XHTD_SERVICES_XB_TROUGH_9.Devices;
using XHTD_SERVICES.Helper.Models.Request;
using XHTD_SERVICES_XB_TROUGH_9.Business;

namespace XHTD_SERVICES_XB_TROUGH_9.Jobs
{
